...
export const CG_TABLE_CORTA: (number | null)[][] = [
  ...
  [1844, 2004, 2154, 2234, 2300, null, 2320],
  // OAT = 5°C
  [1796, 1954, 2120, 2216, 2284, 2316, null],
  // OAT = 10°C
  [1748, 1902, 2066, 2196, 2268, 2300, null],
  // OAT = 15°C
  ...
  // OAT = 38°C
  [null, 1572, 1716, 1874, 2038, 2124, 2204],
  // OAT = 40°C
  [null, 1548, 1690, 1844, 2008, 2093, 2176],
  // OAT = 42°C
  [null, null, 1662, 1814, 1978, 2062, 2144],
  // OAT = 44°C
  [null, null, 1636, 1786, 1944, 2028, 2114],
];
